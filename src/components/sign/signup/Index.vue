<template>
  <div class="sign-form sign-up">
    ...
    <form>
      <div class="input-box">
        <input type="text" placeholder="你的昵称" v-model.trim="nickname">
        <input type="text" name="name" hidden>
        <i class="iconfont ic-user"></i>
        <div class="error-tip"></div>
      </div>
      <div class="input-box">
        <input type="text" placeholder="手机号" v-model.trim="mobile" @blur="veriftyMobile">
        <i class="iconfont ic-phonenumber"></i>
        <div class="error-tip"><span class="error-tip-c" v-show="mobileErorr">{{mobileErorr}}</span></div>
      </div>
      <div class="input-box">
        <input type="text" placeholder="手机验证码" v-model.trim="smsCode">
      ...
      <div class="input-box last">
        <input type="text" placeholder="设置密码" v-model.trim="password">
